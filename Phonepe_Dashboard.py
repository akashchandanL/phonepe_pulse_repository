...
icon = Image.open(r"C:\Users\user\desktop\phonepe4\ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Mithun",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Mithun*!
...
if selected == "Home":
    ...
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :violet[Technologies used :] We have used following technologies in our project Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\user\desktop\phonepe4\Statenames.csv')
            df1.State = df2
